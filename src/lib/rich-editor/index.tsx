...
import {
  ...
  StrikeButton,
  UnderlineButton,
} from "./atoms/character.buttons.tsx";
...
} from "./atoms/layout.controls.tsx";
...
import CharacterCountComponent from "./atoms/ChracterCount.tsx";
import { CodeButton } from "./atoms/code.tsx";
import { TableControls } from "./atoms/TableControls.tsx";
import PreviewBtn from "./atoms/mode.preview.tsx";
import { AlignmentButtons } from "./atoms/alignment.buttons.tsx";
import { HistoryControls } from "./atoms/HistoryButton.tsx";
...
export default function RichEditor() {
  const editor = useEditor({
    extensions: [
      ...
      TextAlign.configure({
        types: ["heading", "paragraph"], // Hansı elementlərdə işləsin
    ...
    content:
      "<h3>Salam Custom Editor!</h3><p>Burada hər şey sizin nəzarətinizdədir.</p>",
  });
  if (!editor) return null;
  return (
    <div className="w-full min-w-50 h-auto bg-gray-100 border border-gray-400 rounded-sm mb-4 p-2">
